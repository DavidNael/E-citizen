...
const String userBirthPlaceField = 'birth_place';
const String userJobsField = 'jobs';
const String userNationalIDField = 'national_id';
...
const String userBachelorLevelField = 'bachelor_level';
const String userHaveBachelorField = 'have_bachelor';
const String userBachelorNameField = 'bachelor_name';
const String userBachelorUniversityField = 'bachelor_university';

//! Master Map
const String userMasterField = 'master';
const String userHaveMasterField = 'have_master';
const String userMasterNameField = 'master_name';
const String userMasterUniversityField = 'master_university';

//! PHD Map
const String userPHDField = 'phd';
